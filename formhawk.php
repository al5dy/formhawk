 ...
 * Description:       Privacy-first form conversion analytics and health monitoring for popular WordPress form plugins and standard HTML forms.
 * Version:           0.3.0
...
define( 'FORMHAWK_VERSION', '0.3.0' );
define( 'FORMHAWK_DB_VERSION', '4' );
